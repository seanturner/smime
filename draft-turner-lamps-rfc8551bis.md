...
author:
 -
    fullname: Blake Ramsdell
    organization: Brute Squad Labs, Inc.
...
normative:
  CHARSETS:
    title: Character sets assigned by IANA
    author:
      org: IANA
...
informative:
  Efail:
    ...
    date: August 2018
  FIPS186-2:
    target: https://csrc.nist.gov/publications/detail/fips/186/2/archive/2000-01-27
    title: >
      Digital Signature Standard (DSS) (also With Change Notice 1)
    author:
    - org: National Institute of Standards and Technology (NIST)
    date: 2000-01
    seriesinfo:
      "FIPS PUB": "186-2"
  SP800-56A: DOI.10.6028/NIST.SP.800-56Ar2
  SP800-57: DOI.10.6028/NIST.SP.800-57pt1r4
  TripleDES: DOI.10.1109/MSPEC.1979.6368160
...
> This term means the same as SHOULD.  However, the authors
...
## Attributes and the SignerInfo Type {#attrs-and-si}
...
of the listed here.  Sending agents SHOULD generate
...
### Encryption Key Preference Attribute
...
## SignerIdentifier SignerInfo Type
...
## Preparing the MIME Entity for Signing, Enveloping, or Compressing
...
Step 3:
: Appropriate transfer encoding is applied to the leaves of the MIME
entity.
...
###  Transfer Encoding for Signing Using multipart/signed
...
## The application/pkcs7-mime Media Type
...
Step 2:
: The MIME entity and other required data are processed into a CMS
...
CEK SHOULD be encrypted for the originator and included in the
EnvelopedData (see {{RFC5652}}, Section 6).

Step 3:
: The EnvelopedData object is wrapped in a CMS ContentInfo object.

Step 4:
: The ContentInfo object is inserted into an application/pkcs7-mime
MIME entity.
...
## Creating an Authenticated Enveloped-Only Message
...
of the CEK for each recipient, a copy of the CEK SHOULD be encrypted
for the originator and included in the AuthEnvelopedData (see {{RFC5083}}).
...
#### The application/pkcs7-signature Media Type
...
Step 1:
: The MIME entity to be signed is prepared according to Section 3.1,
taking special care for clear-signing.

Step 2:
: The MIME entity is presented to CMS processing in order to obtain
...
Step 4:
: Transfer encoding is applied to the "detached signature" CMS
SignedData object, and it is inserted into a MIME entity of
type application/pkcs7-signature.

Step 5:
: The MIME entity of the application/pkcs7-signature is
...
~~~
Note:
: MD5 and SHA-1 are historical and no longer considered secure.
  See Appendix B for details.

Historical note:
: Some early implementations of S/MIME emitted and
...
## Creating a Compressed-Only Message
...
Step 1:
: The certificates and/or CRLs are made available to the CMS
...
Note:
: The ASN.1 module contained herein is unchanged from RFC 5751
...
NOTE:
: Receiving clients SHOULD recognize id-dsa as equivalent to
  id-dsa-with-sha1.
...
# Moving S/MIME v2 Message Specification to Historic Status
...
The version 4 update to the S/MIME documents was done under
the auspices of the LAMPS Working Group.
