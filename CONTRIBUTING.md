...
Working Group mailing list](mailto:spasm@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/spasm/),
[subscribe](https://www.ietf.org/mailman/listinfo/spasm)).
...
[Working Group documents](https://datatracker.ietf.org/wg/lamps/documents/).
