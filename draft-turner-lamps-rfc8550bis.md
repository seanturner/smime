...
abbrev: "S/MIME 4.0 Certificate Handling"
category: std

docname: draft-turner-lamps-rfc8550bis-latest
submissiontype: IETF
...
venue:
  ...
  latest: "https://seanturner.github.io/smime/draft-turner-lamps-rfc8550bis.html"

author:
 -
    fullname: Blake Ramsdell
    organization: Brute Squad Labs
...
normative:
  FIPS186-2:
    ...
    date: January 2000
    seriesinfo:
      FIPS: Federal Information Processing Standard Publication 186-2
  FIPS186-3:
    target: https://csrc.nist.gov/csrc/media/publications/fips/186/3/archive/2009-06-25/documents/fips_186-3.pdf
    title: >
    ...
    date: June 2009
    seriesinfo:
      FIPS: Federal Information Processing Standard Publication 186-3
  X.680:
...
informative:
  ...
  X.500:
    title: >
      ...
      The Directory - Part 1: Overview of concepts, models
      and services
    author:
    seriesinfo:
...
The following reference conventions are used:
...
## Changes since S/MIME 3.2 {#latest-changes}
...
Internet mail address, as described in {{dns-email}}.
...
#  Using Distinguished Names for Internet Mail {#dns-email}
...
pkcs-9-at-emailAddress OBJECT IDENTIFIER ::=<br>
...
component (left-hand side of the '@') SHOULD be compared using a<br />
...
## Certificate and CRL Signing Algorithms, and Key Sizes
...
The following are the RSA and RSASSA-PSS key size requirements for<br />
...
performing issuing-authority operations (see {{ku-ext}}).
...
# Moving S/MIME v2 Certificate Handling to Historic Status
...
The version 4 updates to the S/MIME documents was done under
